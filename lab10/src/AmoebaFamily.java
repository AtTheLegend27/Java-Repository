...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
    ...
    public String longestName() {
        return this.root.longestNameHelper(this.root);
    }
    ...
    public static class Amoeba {
        ...
        public String longestNameHelper(Amoeba amoeba) {
            String maxName = name;
            for (Amoeba a : children) {
                String maxChildName = a.longestNameHelper(a);
                if (maxName.length() < maxChildName.length()){
                    maxName = maxChildName;
                }
            }
            return maxName;
        }
